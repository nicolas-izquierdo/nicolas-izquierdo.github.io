...
Outside academia, I enjoy <a href="#" id="movie-trigger" style="text-decoration: underline; cursor:pointer; color: inherit;">historical and political cinema</a> <div id="movie-card" class="movie-popover" style="display:none;"></div> and <a href="https://www.chess.com/member/nicolas_izq">playing chess</a>.
